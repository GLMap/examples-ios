...
class DemoOverlayView: UIView {
    private static let chromeColor = UIColor.black.withAlphaComponent(0.6)
    ...
    private func setupViews() {
        ...
        captionContainer.backgroundColor = Self.chromeColor
        ...
        exitButton.tintColor = Self.chromeColor
        ...
        NSLayoutConstraint.activate([
            ...
            captionContainer.centerYAnchor.constraint(equalTo: exitButton.centerYAnchor),
