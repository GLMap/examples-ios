...
class LinesPolygonsDemo: DemoMapViewController {
    ...
    private func drawStar(center: GLMapGeoPoint) {
        ...
        builder.addLine(UInt(tips * 2 + 1)) { i in
